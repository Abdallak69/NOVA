...
try:
    ...
    from nova.mitigation.quantum_error_mitigation import (
        ...
        ZeroNoiseExtrapolationMitigation,
        ErrorMitigationFactory,
    )
    # Base backend components from the consolidated interface
    from nova.hardware.quantum_hardware_interface import CirqSimulatorBackend, QuantumBackend
    from nova.core.quantum_logger import configure_logging
...
def test_error_mitigation_strategies():
    ...
    try:
        ...
        zne_mitigation = ZeroNoiseExtrapolationMitigation(
