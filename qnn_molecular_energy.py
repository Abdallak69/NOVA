...
try:
    ...
    from quantum_error_mitigation import ErrorMitigationStrategy  # Base class
    ...
    from quantum_hardware_enhanced import default_provider as enhanced_default_provider
    from quantum_hardware_interface import QuantumBackend  # Base class
